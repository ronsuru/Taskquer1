...
export default function Dashboard() {
  ...
  // Listen for social media connection events
  useEffect(() => {
    const handleSocialMediaConnected = (event: CustomEvent) => {
      const { platform, account } = event.detail;
      setConnectedSocialAccounts(prev => {
        const newMap = new Map(prev);
        newMap.set(platform, account);
        return newMap;
      });
      alert(`${platform} connected successfully!`);
    };

    const handleSocialMediaDisconnected = (event: CustomEvent) => {
    ...
    window.addEventListener('socialMediaConnected', handleSocialMediaConnected as EventListener);
    window.addEventListener('socialMediaDisconnected', handleSocialMediaDisconnected as EventListener);

    return () => {
      window.removeEventListener('socialMediaConnected', handleSocialMediaConnected as EventListener);
      window.removeEventListener('socialMediaDisconnected', handleSocialMediaDisconnected as EventListener);
    };
  }, []);
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {connectedSocialAccounts.has('facebook') && (
                                  <div className="text-xs text-slate-500">
                                    {connectedSocialAccounts.get('facebook')?.username}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            {connectedSocialAccounts.has('facebook') ? (
                              <div className="flex items-center space-x-2">
                                <button
                                  onClick={() => handleSocialMediaDisconnect('facebook')}
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {connectedSocialAccounts.has('twitter') && (
                                  <div className="text-xs text-slate-500">
                                    {connectedSocialAccounts.get('twitter')?.username}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            {connectedSocialAccounts.has('twitter') ? (
                              <div className="flex items-center space-x-2">
                                <button
                                  onClick={() => handleSocialMediaDisconnect('twitter')}
                                  className="px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-red-700"
                                >
                                  Disconnect
                                </button>
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {connectedSocialAccounts.has('youtube') && (
                                  <div className="text-xs text-slate-500">
                                    {connectedSocialAccounts.get('youtube')?.username}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            {connectedSocialAccounts.has('youtube') ? (
                              <div className="flex items-center space-x-2">
                                <button
                                  onClick={() => handleSocialMediaDisconnect('youtube')}
                                  className="px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-red-700"
                                >
                                  Disconnect
                                </button>
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {connectedSocialAccounts.has('discord') && (
                                  <div className="text-xs text-slate-500">
                                    {connectedSocialAccounts.get('discord')?.username}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            {connectedSocialAccounts.has('discord') ? (
                              <div className="flex items-center space-x-2">
                                <button
                                  onClick={() => handleSocialMediaDisconnect('discord')}
                                  className="px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-red-700"
                                >
                                  Disconnect
                                </button>
                              ...
                              <button
                                onClick={() => handleSocialMediaConnect('discord')}
                          ...
                          <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {connectedSocialAccounts.has('tiktok') && (
                                  <div className="text-xs text-slate-500">
                                    {connectedSocialAccounts.get('tiktok')?.username}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            {connectedSocialAccounts.has('tiktok') ? (
                              <div className="flex items-center space-x-2">
                                <button
                                  onClick={() => handleSocialMediaDisconnect('tiktok')}
                                  className="px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-red-700"
                                >
                                  Disconnect
                                </button>
